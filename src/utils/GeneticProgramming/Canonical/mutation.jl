...
"""
    subtreeMutation(genotype::CGPGenotype,
                    gpExperimentInfo::CGPInfo,
                    rng::Random.AbstractRNG,
...
# Self-provided Arguments
- `genotype::CGPGenotype`: genotype of the individual that is
    going to be mutated.
- `gpExperimentInfo::CGPInfo`: information about the GP experiment.
- `rng::Random.AbstractRNG`: random number generator for random number consistency
    along an experiment.
...
"""
function subtreeMutation(genotype::CGPGenotype,
                         gpExperimentInfo::CGPInfo,
                         rng::Random.AbstractRNG,
                         method::Function = fullGenerator)
...
"""
function getDefaultMutationOp(individualType::Type{CGPGenotype})::Tuple{Function, Array}
