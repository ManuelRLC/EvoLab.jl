...
documentation
"""
function parseGPExperimentInfo(type::Type{STGPGenotype}, GPInfoDict::Dict, experiment::GenJulia)
    ...
    setSTGPInfo(varValues..., nodesFile=nodesFile, maxTreeDepth=maxTreeDepth, genj=experiment)
end
