...
"""
    rampedHalfHalfGenerator(gpExperimentInfo::STGPInfo, popSize::UInt32,
...
"""
function rampedHalfHalfGenerator(gpExperimentInfo::STGPInfo, popSize::UInt32,
                                 rng::Random.AbstractRNG, RHHFactor::Float64 = 0.5)

    population = Array{STGPGenotype}(undef, popSize)
    N = popSize - round(Int64, popSize * RHHFactor)
