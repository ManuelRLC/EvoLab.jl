using .EvoLab.GA.BinaryGA: BinaryGenotype
using .EvoLab.GA.IntegerGA: IntegerGenotype
...
function checkParametersCorrectGP(genj::GenJulia, index::Int64 = 0)
    ...
    All = true
    ind = 0
#genj._generator._method(genj._experimentInfo._GPExperimentInfo, rng, genj._generator._varArgs...)
...
ind = genj._generator._method(genj._experimentInfo._GPExperimentInfo, one(UInt32), rng, genj._generator._varArgs...)
    ...
    if index == 0
        ...
        ind = All ? genj._generator._method(genj._experimentInfo._GPExperimentInfo, 1, rng, genj._generator._varArgs...) : genj._generator._method(genj._experimentInfo._GPExperimentInfo, rng, genj._generator._varArgs...)
...
#childMut = genj._mutationOp._method(individuals[1], genj._experimentInfo._GPExperimentInfo, rng, genj._mutationOp._varArgs...)
        ...
        """
#fitness = fitnessEval(genj._evaluator._fitnessFunctions[2], genj._experimentInfo._GPExperimentInfo, individuals[1])
    """
        try
            len = length(genj._evaluator._fitnessFunctions)
            k = 1
...
println(precompile(checkParametersCorrectGP, tuple(GenJulia, Int64)))
